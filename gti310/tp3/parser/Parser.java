 ...
 * is that two specialized classes can produce different outputs. The owner will
 * have to know in advance what type of object will be produced by the method
 ...
 *
 * @param <E>
 *            A template that must be redifined by the implementations of the
 *            Parser interface.
 */
public interface Parser<E> {
	 ...
	 * 
	 * @param filename
	 *            The complete path to the file to parse.
	 * @return An object produced from the input file, or null if something went
	 *         wrong.
	 * @throws IOException
	 */
