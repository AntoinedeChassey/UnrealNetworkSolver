 ...
 *
 * @param <T>
 *            The user-defined object that will be written to file.
 */
public interface Writer<T> {
	 ...
	 * 
	 * @param filename
	 *            The complete path to the file that will be created.
	 * @param output
	 *            The data which will be written to the file.
	 * @throws IOException
	 */
	void write(String filename, T output) throws IOException;
}
